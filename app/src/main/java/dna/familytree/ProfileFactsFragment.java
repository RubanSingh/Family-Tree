...
public class ProfileFactsFragment extends BaseFragment {
    ...
    public static String writeEventText(EventFact event) {
        ...
        if (indirizzo != null) txt += DetailController.writeAddress(indirizzo, true) + "\n";
        ...
        if (object instanceof Name) {
            ...
            eventView.setOnClickListener(v -> {
                ...
                if (!Global.settings.expert && nomeComplesso((Name)object)) {
                    new MaterialAlertDialogBuilder(getContext()).setMessage(R.string.complex_tree_advanced_tools)
                            .setPositiveButton(android.R.string.ok, (dialog, i) -> {
                                Global.settings.expert = true;
                                Global.settings.save();
                                Memory.add(object);
                                startActivity(new Intent(getContext(), NameController.class));
            ...
            if (((EventFact)object).getTag() != null && ((EventFact)object).getTag().equals("SEX")) {
                ...
                eventView.setOnClickListener(view -> new MaterialAlertDialogBuilder(view.getContext())
            ...
            eventView.setOnClickListener(v -> {
                Memory.add(object);
                startActivity(new Intent(getContext(), ExtensionController.class));
            });
        }
    }
    ...
    public void onResume() {
        super.onResume();
        AnalyticsUtil.logProfileFactsFragment(getFirebaseAnalytics());
    }
}

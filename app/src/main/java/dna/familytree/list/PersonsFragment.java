...
public class PersonsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle) {
        ...
        if (gc != null) {
            ...
            view.findViewById(R.id.fab).setOnClickListener(v -> {
                AnalyticsUtil.logEventAddPerson(getFirebaseAnalytics());
    ...
    private class PersonsAdapter extends RecyclerView.Adapter<IndiHolder> implements Filterable {
        ...
        public void onBindViewHolder(IndiHolder indiHolder, int position) {
            ...
            switch (Gender.getGender(person)) {
                case MALE:
                    border = R.drawable.male_bg;
                    break;
                case FEMALE:
                    border = R.drawable.female_bg;
                    break;
                default:
                    border = R.drawable.nutral;
            }
        ...
        Collections.sort(selectedPeople, (wrapper1, wrapper2) -> {
            ...
            switch (order) {
                ...
                case SURNAME_ASC: // Sort for surname
                    AnalyticsUtil.logEventSortSurname(getFirebaseAnalytics());
                ...
                case DATE_ASC: // Sort for person's main year
                    AnalyticsUtil.logEventSortDate(getFirebaseAnalytics());
                ...
                case AGE_ASC: // Sort for main person's year
                    AnalyticsUtil.logEventSortAge(getFirebaseAnalytics());
                ...
                case KIN_ASC: // Sort for number of relatives
                    AnalyticsUtil.logEventSortRelatives(getFirebaseAnalytics());
    ...
    public void onResume() {
        super.onResume();
        AnalyticsUtil.logPersonsFragment(getFirebaseAnalytics());
    }
}

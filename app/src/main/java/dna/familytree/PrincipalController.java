...
public class PrincipalController extends BaseController implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuPrincipe.getHeaderView(0).findViewById(R.id.menu_alberi).setOnClickListener(v -> {
            ...
            startActivity(new Intent(PrincipalController.this, TreesController.class));
        });
    ...
    protected void onResume() {
        super.onResume();
        AnalyticsUtil.logEventPrincipalActivity(getFirebaseAnalytics());
    }

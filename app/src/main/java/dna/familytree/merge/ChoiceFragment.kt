...
import dna.familytree.databinding.MergeChoiceFragmentBinding
...
class ChoiceFragment : BaseFragment(R.layout.merge_choice_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        for (tree in model.trees) {
            ...
            treeView.findViewById<TextView>(R.id.merge_detail).text = TreesController.writeData(context, tree)

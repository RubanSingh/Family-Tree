 ...
 */
public class CropImageController extends BaseController
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(this.<Toolbar>findViewById(com.theartofdev.edmodo.cropper.R.id.toolbar));
    ...
    public void onRequestPermissionsResult(
        ...
        if (requestCode == CropImage.PICK_IMAGE_PERMISSIONS_REQUEST_CODE) {
            if (mCropImageUri != null
                ...
                Toast.makeText(this, com.theartofdev.edmodo.cropper.R.string.crop_image_activity_no_permissions, Toast.LENGTH_LONG).show();
                setResultCancel();
            }
        }

...
package dna.familytree.cropper;
...
public final class CropImage {
  ...
  /** The key used to pass crop image source URI to {@link CropImageController}. */
  public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

  /** The key used to pass crop image options to {@link CropImageController}. */
  public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

  /** The key used to pass crop image bundle data to {@link CropImageController}. */
  public static final String CROP_IMAGE_EXTRA_BUNDLE = "CROP_IMAGE_EXTRA_BUNDLE";

  /** The key used to pass crop image result data back from {@link CropImageController}. */
  ...
  /**
   * The request code used to start {@link CropImageController} to be used on result to identify the
   * this specific request.
   */
  public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

  /** The result code used to return error from {@link CropImageController}. */
  ...
  public static Intent getPickImageChooserIntent(@NonNull Context context) {
    return getPickImageChooserIntent(
        context, context.getString(com.theartofdev.edmodo.cropper.R.string.pick_image_intent_chooser_title), false, true);
  }
   ...
   * CropImageController} to crop the selected image.<br>
  ...
  /**
   * Create {@link ActivityBuilder} instance to start {@link CropImageController} to crop the given
   * image.<br>
   * Result will be received in {@link Activity#onActivityResult(int, int, Intent)} and can be
   * retrieved using {@link #getActivityResult(Intent)}.
   *
  ...
  /**
   * Get {@link CropImageController} result data object for crop image activity started using {@link
   * #activity(Uri)}.
   *
  ...
  public static final class ActivityBuilder {
    ...
    /** Get {@link CropImageController} intent to start the activity. */
    public Intent getIntent(@NonNull Context context) {
      return getIntent(context, CropImageController.class);
    }
    ...
    /**
     * Start {@link CropImageController}.
     *
    ...
    /**
     * the title of the {@link CropImageController}.<br>
     * <i>Default: ""</i>
     */

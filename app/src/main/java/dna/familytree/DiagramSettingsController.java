...
public class DiagramSettingsController extends BaseController {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        spouses.setOnCheckedChangeListener((button, active) -> {
            AnalyticsUtil.logEventSettingsAddPartner(getFirebaseAnalytics());
    ...
    protected void onResume() {
        super.onResume();
        AnalyticsUtil.logEventDiagramSettingsActivity(getFirebaseAnalytics());
    }

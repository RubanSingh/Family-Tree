...
public class ProcessController extends BaseController {
    ...
    protected void onResume() {
        super.onResume();
        AnalyticsUtil.logEventProcessActivity(getFirebaseAnalytics());
    }
    ...
    void arredaScheda(Gedcom gc, int idScheda, Object o) {
        ...
        if (o instanceof Note) {
            ...
            if (s.getAddress() != null) txt += DetailController.writeAddress(s.getAddress(), true);
            ...
            if (r.getAddress() != null)
                txt += DetailController.writeAddress(r.getAddress(), true) + "\n";
    ...
    void vaiAvanti() {
        ...
        if (getIntent().getIntExtra("posizione", 0) == Comparison.getList().size()) {
            ...
            intent.setClass(this, ConfirmationController.class);
        } else {
            // Prossimo confronto
            intent.setClass(this, ProcessController.class);

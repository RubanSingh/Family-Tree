...
public class CompareController extends BaseController {
    ...
    private String TAG = CompareController.class.getSimpleName();
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (Comparison.getList().size() > 0) {
            ...
            button1.setOnClickListener(v -> {
                startActivity(new Intent(CompareController.this, ProcessController.class).putExtra("posizione", 1));
            });
            // 'Accept all' button
            button2.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(CompareController.this, ProcessController.class);
            ...
            button1.setOnClickListener(v -> {
                TreesController.deleteTree(CompareController.this, idTree2);
                onBackPressed();
            });
    ...
    protected void onResume() {
        super.onResume();
        AnalyticsUtil.logEventCompareActivity(getFirebaseAnalytics());
    }
    ...
    private boolean isRecent(Change change) {
        ...
        if (change != null && change.getDateTime() != null) {
            try { // TODO: test also with null Time
                ...
                LoggerUtils.ErrorLog(TAG, "Exception in isRecent", e);
            }
        }
        return itIs;
    }
    ...
    Change getChange(Object object) {
        ...
        try {  // TODO: to avoid this, split the check on all the objects with instanceof
            ...
            LoggerUtils.ErrorLog(TAG, "Exception in getChange", e);
        }
        return change;
    }
    ...
    void populateCard(Gedcom gedcom, int treeId, int cardId) {
        ...
        data.setText(TreesController.writeData(this, tree));

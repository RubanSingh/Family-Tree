...
public class ConfirmationController extends BaseController {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (!Comparison.getList().isEmpty()) {
            ...
            String txt = TreesController.writeData(this, tree);
            ...
            findViewById(R.id.conferma_annulla).setOnClickListener(v -> {
                Comparison.reset();
                startActivity(new Intent(ConfirmationController.this, TreesController.class));
            });
            ...
            findViewById(R.id.conferma_ok).setOnClickListener(v -> {
                ...
                if (allOk) {
                    ...
                    new MaterialAlertDialogBuilder(ConfirmationController.this)
                            .setMessage(R.string.all_imported_delete)
                            .setPositiveButton(android.R.string.ok, (d, i) -> {
                                TreesController.deleteTree(this, Global.treeId2);
                                done();
    ...
    protected void onResume() {
        super.onResume();
        AnalyticsUtil.logEventConfirmationActivity(getFirebaseAnalytics());
    }
    ...
    void done() {
        Comparison.reset();
        startActivity(new Intent(this, TreesController.class));
    }

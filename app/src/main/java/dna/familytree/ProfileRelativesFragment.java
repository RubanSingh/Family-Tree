...
public class ProfileRelativesFragment extends BaseFragment {
    ...
    public void onCreateContextMenu(ContextMenu menu, View vista, ContextMenu.ContextMenuInfo info) {
        ...
        if (FamilyController.findParentFamilyRef(person, family) != null)
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (id == 300) { // Diagramma
            ...
            FamilyController.chooseLineage(getContext(), person, family);
    ...
    public void onResume() {
        super.onResume();
        AnalyticsUtil.logProfileRelativesFragment(getFirebaseAnalytics());
    }
}

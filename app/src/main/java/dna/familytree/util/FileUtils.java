...
public class FileUtils {
    ...
    static class CacheImage extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... url) {
            try {
                ...
                org.apache.commons.io.FileUtils.copyURLToFile(url[0], cache);
    ...
    public static boolean proposeCropping(Context context, Fragment fragment, Intent data, Media media) {
        ...
        if (path != null && path.lastIndexOf('/') > 0) { // If it is a full path to the file
            ...
            try { // We use the URI
                ...
                org.apache.commons.io.FileUtils.copyInputStreamToFile(input, fileMedia[0]); // Crea la cartella se non esiste
            } catch (Exception e) {
        ...
        if (mimeType != null && mimeType.startsWith("image/")) {
            ...
            FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, AppUtils.dpToPx(320));
     ...
     */
    public static void cropImage(Context context, File fileMedia, Uri uriMedia, Fragment fragment) {
        // Origin
        if (uriMedia == null)

...
public class F {
                ...
                if (id.matches("\\d+")) {
                    ...
                    for (String contentUriPrefix : contentUriPrefixesToTry) {
                        ...
                        try {
                            ...
                            LoggerUtils.ErrorLog(TAG, "Exception in uriFilePath", e);
                        }
                    }
                }
        }
                    ...
                    .into(imageView, new Callback() {
                        ...
                        public void onSuccess() {
                            ...
                            if (imageView.getDrawable() instanceof BitmapDrawable
                                    && imageView instanceof ShapeableImageView) {
                                ColorStateList colorStateList = getVibrantColor(((BitmapDrawable)imageView.getDrawable()).getBitmap());
                                ((ShapeableImageView)imageView).setStrokeColor(colorStateList);
                            }
                        }

                        private ColorStateList getVibrantColor(Bitmap bitmap) {
                            Palette palette = Palette.from(bitmap).generate();
                            int defaultColor = imageView.getContext().getResources().getColor(R.color.accent);
                            int vibrantColor = defaultColor;
                            if (palette.getDominantSwatch() != null) {
                                vibrantColor = palette.getDominantColor(defaultColor);
                            }
                        ...
                        public void onError(Exception e) {
                            ...
                            try { // To avoid crashing of video thumbnail generators
                                ...
                                LoggerUtils.ErrorLog(TAG, "Exception in onError", excpt);
                            }
                    ...
                    .into(imageView, new Callback() {
                        ...
                        public void onSuccess() {
                            ...
                            try {
                                ...
                                LoggerUtils.ErrorLog(TAG, "Exception in showImage", e);
                            }
                        }
    ...
    static class CacheImage extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... url) {
            try {
                ...
                LoggerUtils.ErrorLog(TAG, "Exception in CacheImage", e);
                e.printStackTrace();
            }
            return null;
        }
    ...
    static class DownloadImage extends AsyncTask<String, Integer, Bitmap> {
        ...
        protected Bitmap doInBackground(String... params) {
            ...
            try {
                ...
                LoggerUtils.ErrorLog(TAG, "Exception in DownloadImage", e);
                return null;
            }
            return bitmap;
        }
    ...
    public static void displayImageCaptureDialog(Context context, Fragment fragment, int code, MediaContainer container) {
        ...
        new MaterialAlertDialogBuilder(context).setAdapter(createAdapter(context, resolveInfos),
                (dialog, id) -> {
                    ...
                    if (intent.getComponent().getPackageName().equals("dna.familytree")) { // TODO: extract to build property
    ...
    private static ArrayAdapter<ResolveInfo> createAdapter(final Context context, final List<ResolveInfo> resolveInfos) {
        return new ArrayAdapter<ResolveInfo>(context, R.layout.piece_app, R.id.app_title, resolveInfos) {
            ...
            public View getView(int position, View view1, ViewGroup parent) {
                ...
                if (info.activityInfo.packageName.equals("dna.familytree")) {
    ...
    public static boolean proposeCropping(Context context, Fragment fragment, Intent data, Media media) {
        ...
        if (path != null && path.lastIndexOf('/') > 0) { // If it is a full path to the file
            ...
            try { // We use the URI
                ...
                LoggerUtils.ErrorLog(TAG, "Exception in proposeCropping", e);
    ...
    static void finishProposeCropping(Context context, Fragment fragment) {
        ...
        else if (context instanceof DetailController)
            ((DetailController)context).refresh();
        else if (context instanceof ProfileController) {
    ...
    static void cropImage(Context context, File fileMedia, Uri uriMedia, Fragment fragment) {
        ...
        Intent intent = CropImage.activity(uriMedia)
                ...
                .setActivityMenuIconColor(context.getResources().getColor(R.color.text))
